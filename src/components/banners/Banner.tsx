...
function Banner(_props: any) {
  return (
    <Box height="auto" width="100%" mb={2} sx={{ background: 'black' }}>
      <Carousel
        indicators
...
function Item(props: { item: {
  ...
  return (
    <Box height="100vh" width="100%" sx={{ background: 'black' }}>
      <Paper style={{ height: '100%', background: 'black', position: 'relative', display: 'flex', flexDirection: 'row', justifyContent: 'start', alignItems: 'center' }}>
